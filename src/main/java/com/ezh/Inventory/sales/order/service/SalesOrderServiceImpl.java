...
import com.ezh.Inventory.sales.order.dto.SalesConversionDateProjection;
    ...
    public List<SalesConversionReportDto> getSalesOrderConversionReport(CommonFilter filter) throws CommonException {
        ...
        return projections.stream().map(projection -> {
            ...
            return SalesConversionReportDto.builder()
                    .reportDate(projection.getReportDate() != null ? projection.getReportDate().toLocalDate() : null)
